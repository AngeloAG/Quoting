...
import 'package:quoting/presentation/pages/edit_quote/edit_quote.dart';
import 'package:quoting/presentation/pages/home/home.dart';
import 'package:quoting/presentation/pages/login/login.dart';
import 'package:quoting/presentation/pages/settings/settings.dart';
import 'package:quoting/presentation/pages/view_quote/view_quote.dart';
  ...
  locationBuilder: RoutesLocationBuilder(
    routes: {
      ...
      'settings': (context, state, data) => BlocProvider(
            create: (_) => serviceLocator<BackupRestoreBloc>(),
